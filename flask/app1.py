...
# # Load the VGG model
# vgg_model = load_model('models/my_vgg_model.h5')

# # Load the RNN model
# rnn_model = load_model('models/my_rnn_model.h5')
...
# class_names_multiclass_vgg = ["Alstonia Scholaris", "Arjun", "Jamun"]
# class_names_multiclass_rnn = ["Jamun", "Arjun", "Alstonia Scholaris"]  # Update with actual class names

# # Threshold for binary classification
# threshold_binary = 0.5
# class_names_binary = ["Arjun", "Alstonia Scholaris"]  # Update with actual class names
...
#                 elif selected_model_name == 'my_vgg_model':  # Multi-class classification for VGG model
#                     class_index = np.argmax(prediction)
#                     class_name = class_names_multiclass_vgg[class_index]
#                 else:  # Multi-class classification for RNN model
#                     class_index = np.argmax(prediction)
#                     class_name = class_names_multiclass_rnn[class_index]
